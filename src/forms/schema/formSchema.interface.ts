...
export interface VisibilityRule {
  when: { field: string; op: VisibilityOp; value: any }
...
export interface ViewQueryOptionsSource {
  ...
  labelField: string
  searchField?: string
  filters?: Array<{ field: string; op: VisibilityOp; value: any }>
}
...
export interface ApiOptionsSource {
  ...
  mapping: { value: string; label: string; color?: string }
}
