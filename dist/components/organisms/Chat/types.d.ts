...
export declare function createOptimisticOutgoingMessage({ currentUserId, currentUserName, currentUserAvatarUrl, input, createdAt, }: CreateOptimisticMessageParams): ChatMessage;
