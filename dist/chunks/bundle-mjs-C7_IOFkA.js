...
const B = "-", ne = (e) => {
  ...
  return {
    getClassGroupId: (a) => {
      const s = a.split(B);
      return s[0] === "" && s.length !== 1 && s.shift(), D(s, r) || se(a);
    },
  ...
  for (let u = a.length - 1; u >= 0; u -= 1) {
    ...
    const p = pe(m).join(":"), f = y ? p + ee : p, h = f + b;
    if (n.includes(h))
      continue;
    n.push(h);
    const R = l(b, w);
...
const c = (e) => {
...
}, te = /^\[(?:([a-z-]+):)?(.+)\]$/i, he = /^\d+\/\d+$/, ye = /* @__PURE__ */ new Set(["px", "full", "screen"]), xe = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, we = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, ve = /^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/, ke = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, Ce = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, C = (e) => M(e) || ye.has(e) || he.test(e), z = (e) => G(e, "length", Pe), M = (e) => !!e && !Number.isNaN(Number(e)), _ = (e) => G(e, "number", M), P = (e) => !!e && Number.isInteger(Number(e)), ze = (e) => e.endsWith("%") && M(e.slice(0, -1)), i = (e) => te.test(e), A = (e) => xe.test(e), Ae = /* @__PURE__ */ new Set(["length", "size", "percentage"]), Se = (e) => G(e, Ae, oe), Me = (e) => G(e, "position", oe), Ge = /* @__PURE__ */ new Set(["image", "url"]), Re = (e) => G(e, Ge, Ee), Ie = (e) => G(e, "", je), j = () => !0, G = (e, r, t) => {
  const o = te.exec(e);
  ...
  we.test(e) && !ve.test(e)
), oe = () => !1, je = (e) => ke.test(e), Ee = (e) => Ce.test(e), Ne = () => {
